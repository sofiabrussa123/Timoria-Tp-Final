    ...
    public Menu(Game juego) {
        ...
        botonJugar.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                // Pasar PantallaEsperandoJugadores.class como siguiente pantalla
                //cambiarEscena(new SecuenciaImagenes(juego, imagenesIntro, PantallaEsperandoJugadores.class));
                cambiarEscena(new ControladorDeConexiones(juego));
            }
        });
