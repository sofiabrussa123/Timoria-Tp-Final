...
public enum Estado {
    ...
    // 3. Constructor para inicializar los campos del Enum:
    ...
    public Animation<TextureRegion> crearAnimacion() {
        ...
        // Recorremos la matriz para aplanar los cuadros en un Array
        ...
        if (cuadros.size == 0) {
            throw new IllegalArgumentException("La hoja de sprites no contiene cuadros o no se ha cargado correctamente: " + rutaHoja);
        }
